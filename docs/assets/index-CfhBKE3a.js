(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[`one`,`two`,`three`,`four`,`five`,`six`,`seven`,`eight`,`nine`,`ten`],t=[{tens:2,ones:1},{tens:1,ones:5},{tens:3,ones:4},{tens:4,ones:5},{tens:6,ones:2}],n=`abcdefghijklmnopqrstuvwxyz`,r=document.querySelector(`#app`),i=`baxter`,a=`/austin-homework/hero.png`,o=0,s=!1,c=!1,l=``,u=[],d=[],f=0,p=``,m=``,h=`tens`,g=`login`,_=0,v=!1,y=``,b=``,x=0,S=0,C={},w={},T=`spell`;function E(e){return e.length}function D(){return e.reduce((e,t)=>e+t.length,0)}function O(){try{return JSON.parse(localStorage.getItem(`austin-scores`)||`[]`)}catch{return[]}}function k(){let e=O();e.unshift({when:new Date().toLocaleString(),spell:x,spellMax:D(),maths:S,mathsMax:t.length}),localStorage.setItem(`austin-scores`,JSON.stringify(e.slice(0,20)))}function A(){return O()[0]}function j(e,t){let n=t?Math.round(e/t*5):0;return`★`.repeat(n)+`☆`.repeat(5-n)}function M(){for(let e=0;e<48;e++){let t=document.createElement(`div`);t.className=`bit`,t.style.left=Math.random()*100+`vw`,t.style.background=[`#c41e3a`,`#f4d35e`,`#2d5bff`,`#fff`][e%4],t.style.animationDelay=Math.random()*.4+`s`,document.body.appendChild(t),setTimeout(()=>t.remove(),2500)}}function N(){d.forEach(e=>clearTimeout(e)),d=[];try{speechSynthesis.cancel()}catch{}}function P(e,t){d.push(setTimeout(t,e))}function F(t){if(v=!0,g===`spell`&&H(),P(850,()=>{v=!1,g===`spell`&&H()}),e.indexOf(t)!==-1){let e=new Audio(`/austin-homework/sounds/`+t+`.mp3`);e.playsInline=!0;let n=e.play();n&&n.catch&&n.catch(function(){})}try{speechSynthesis.cancel();let e=new SpeechSynthesisUtterance(t);e.rate=.75,speechSynthesis.speak(e)}catch{}}function I(e){return e.map(e=>({item:e,sort:Math.random()})).sort((e,t)=>e.sort-t.sort).map(({item:e})=>e)}function L(e){let t=I(n.split(``)).filter(t=>!e.includes(t)).slice(0,e.length<5?3:2);return I([...e.split(``),...t])}function R(e,t){return Array.from({length:e},()=>t===`ten`?`<span class="rod"></span>`:`<span class="cube"></span>`).join(``)}function z(){let t=e[o];N(),s=!1,c=!0,l=``,u=L(t),_=5,v=!1,H();function n(){P(1e3,()=>{--_,_>0?(H(),n()):(F(t),P(2e3,()=>{F(t),P(2e3,()=>{F(t),P(800,()=>{s=!0,c=!1,H()})})}),H())})}n()}function B(){T=`spell`,k(),g=`result`,H(),x===D()&&M()}function V(){T=`maths`,k(),g=`result`,H(),S===t.length&&M()}function H(){if(g===`login`){r.innerHTML=`
    ...
    <main class="card">
      ...
      <div class="build">
        <div class="rods">${R(n.tens,`ten`)}</div>
        <div class="ones">${R(n.ones,`one`)}</div>
      </div>
  ...
  `}function U(n,r){if(n){if(n===`logout`){g=`login`,y=``,b=``,N(),H();return}if(n===`pick-austin`){g=`pass`,y=``,b=``,H();return}if(n===`pass-letter`){y+=r,b=``,H();return}if(n===`pass-clear`){y=``,b=``,H();return}if(n===`pass-go`){y===i?(g=`home`,y=``,b=``):(b=`Try again`,y=``),H();return}if(n===`home`){g=`home`,N(),H();return}if(n===`spell`){g=`spell`,o=0,x=0,C={},z();return}if(n===`maths`){g=`maths`,f=0,S=0,w={},p=``,m=``,h=`tens`,N(),H();return}if(n===`hear`){F(e[o]);return}if(n===`letter`){if(!s||c||_>0)return;l+=r,H();return}if(n===`check-spell`){let t=e[o],n=document.querySelector(`#result`);l===t?(C[o]||(x+=E(t),C[o]=!0),n.textContent=`Correct Well Done!`,n.className=`ok`,F(`Well done`),P(1400,()=>{o>=e.length-1?B():(o+=1,z())})):(l=``,u=L(t),H(),document.querySelector(`#result`).textContent=`Try again`,document.querySelector(`#result`).className=`no`);return}if(n===`again`){z();return}if(n===`next-word`){o>=e.length-1?B():(o+=1,z());return}if(n===`tens`){h=`tens`,H();return}if(n===`ones`){h=`ones`,H();return}if(n===`num`){h===`tens`?p=r:m=r,H();return}if(n===`check-maths`){let e=t[f],n=document.querySelector(`#result`);Number(p)===e.tens&&Number(m)===e.ones?(w[f]||(S+=1,w[f]=!0),n.textContent=`Correct Well Done!`,n.className=`ok`,F(`Well done`),P(1400,()=>{f>=t.length-1?V():(f+=1,p=``,m=``,h=`tens`,H())})):(n.textContent=`Try again`,n.className=`no`);return}if(n===`clear`){p=``,m=``,h=`tens`,H();return}n===`next-maths`&&(f>=t.length-1?V():(f+=1,p=``,m=``,h=`tens`,H()))}}function W(e){let t=e;for(;t&&t!==r;){if(t.getAttribute&&t.getAttribute(`data-act`))return t;t=t.parentNode}return null}r.onclick=function(e){let t=W(e.target);t&&(t.className||``).indexOf(`off`)===-1&&U(t.getAttribute(`data-act`),t.getAttribute(`data-val`))},H();